...
namespace GameFramework.CustomCollections
{
    [CustomPropertyDrawer(typeof(DrawableDictionary), true)]
    public class DictionaryPropertyDrawer : PropertyDrawer
    {
        private readonly string _dictionaryValueNameProperty = "_values";
        private readonly string _dictionaryKeyNameProperty = "_keys";

        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            if (property.isExpanded)
            {
                var keysProp = property.FindPropertyRelative(_dictionaryKeyNameProperty);
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (expanded)
            {
                ...
                var keysProp = property.FindPropertyRelative(_dictionaryKeyNameProperty);
                var valuesProp = property.FindPropertyRelative(_dictionaryValueNameProperty);
