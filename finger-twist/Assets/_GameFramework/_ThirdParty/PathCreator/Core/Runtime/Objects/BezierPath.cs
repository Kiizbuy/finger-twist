...
namespace PathCreation
{
    ...
    public class BezierPath
    {
        ...
        /// Get world space position of point
        public Vector3 GetPoint(int i) => points[i];
        ...
        public float GetAnchorNormalAngle(int anchorIndex) => perAnchorNormalsAngle[anchorIndex] % 360;
